...
public class Aplikacja {
	...
	public boolean autoryzacjaSprzedazy(Bilet bilet, Pracownik pracownik) {
		...
		try {
			...
			System.out.println("Bilet zostaje usuniety, klient nie posiada wymaganych srodk�w w saldzie");
			...
			throw new RuntimeException("Bilet zostaje usuniety, klient nie posiada wymaganych srodk�w w saldzie");
		}
		return false;
	}
